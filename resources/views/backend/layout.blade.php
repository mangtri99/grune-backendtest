...
<html>
    ...
    <body class="hold-transition skin-blue-light sidebar-mini @yield('body-class')">
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li id="menu-companies" class="{{ (request()->is('company*')) ? 'treeview menu-open active' : 'treeview' }}">
                            <a href="#">
                                <i class="fa fa-building-o"></i>
                                <span>Companies</span>
                            </a>
                            <ul class="treeview-menu">
                                <li class="add-companies"><a class="{{ (request()->is('company/*')) ? 'sub-menu-active' : '' }}" href="{{route('company.create')}}"><i class="fa fa-circle-o"></i> Add / Edit</a></li>
                                <li class="list-companies"><a class="{{ (request()->is('company')) ? 'sub-menu-active' : '' }}" href="{{ route('company.index')}}"><i class="fa fa-circle-o"></i> List</a></li>
                            </ul>
                        </li>
                    </ul>
                </section>
        ...
        <script type="text/javascript"> var getPostCode = "{{ url('/api/admin/postcode/getPostCode/') }}";</script>
