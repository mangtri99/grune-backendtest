...
Route::GROUP(['middleware' => ['auth:user']], function() {
    ...
    // Route::RESOURCE('/company', 'Backend\CompanyController')->name('*','company');
    Route::get('/company', 'Backend\CompanyController@index')->name('company.index');
    Route::get('/company/add', 'Backend\CompanyController@create')->name('company.create');
    Route::post('/company/create', 'Backend\CompanyController@store')->name('company.store');
    Route::get('/company/edit/{id}', 'Backend\CompanyController@edit')->name('company.edit');
    Route::post('/company/update/{id}', 'Backend\CompanyController@update')->name('company.update');
    Route::GET('/company/delete', 'Backend\CompanyController@destroy')->name('company.destroy');
});
